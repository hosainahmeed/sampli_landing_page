...
function RegisterReffer() {
  return (
    <Card className="!w-full mb-28 !p-8 sm:!p-12 md:!p-16 !rounded-2xl bg-gradient-var2 shadow-lg">
      <div className="text-center max-w-screen-lg mx-auto flex flex-col items-center gap-6">
        <div className="w-full px-4">
          ...
          <Text className="!text-white text-sm sm:text-base mt-2 md:text-lg tracking-wide max-w-2xl mx-auto block leading-relaxed">
